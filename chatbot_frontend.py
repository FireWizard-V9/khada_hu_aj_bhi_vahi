...
st.title("Yo, I am Fire-Wizard :sunglasses:") # **Modify this based on the title you want in want
...
input_text = st.chat_input("I am Bahubali of Mirzapur") # **display a chat input box
if input_text: 
